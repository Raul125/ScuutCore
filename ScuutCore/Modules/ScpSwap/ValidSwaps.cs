...
namespace ScuutCore.Modules.ScpSwap
{
    ...
    public static class ValidSwaps
    {
        ...
        private static void RefreshCustomSwaps()
        {
            ...
            {
                if (ScpSwap.Singleton.Config.BlacklistedNames != null &&
                    ScpSwap.Singleton.Config.BlacklistedNames.Contains(customSwap.Name, StringComparison.OrdinalIgnoreCase))
                    continue;
